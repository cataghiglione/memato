...
public class MySystem {
    ...
    public Optional<Search> findOrCreateSearch(CreateSearchForm form, Team team, TimeInterval time) {
        return runInTransaction(datasource -> {
            ...
            try {
                return searches.exists(Long.toString(team.getId()), time.getIntervals(), form.getDate(), form.getLatitude(), form.getLongitude(),
                        form.getAge(), form.isRecurring()) ?
                        searches.reactivateSearch(team, time.getIntervals(), form.getDate(), form.getLatitude(), form.getLongitude(),
                                form.getAge(), form.isRecurring())
                        : Optional.of(searches.createSearch(team, form.getDate(), time.getIntervals(), form.getLatitude(), form.getLongitude(),
                        form.getAge(), form.isRecurring()));
